...
def persistence_computation(filtered_v_, edge_index, vertex_slices, edge_slices, batch):
...
class SimpleSetTopoLayer(nn.Module):
    ...
    def compute_persistence(self, x, edge_index, vertex_slices, edge_slices, batch, return_filtration = False):
        ...
        return persistence_computation(filtered_v, edge_index, vertex_slices, edge_slices, batch)
